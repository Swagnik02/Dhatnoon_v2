...
class ColorConstants {
  // static const Color primaryColor = Color.fromARGB(a, r, g, b);

  //auth page
  static const Color authBackground = Color.fromARGB(255, 35, 45, 54);
  static const Color authTextFieldBg = Color.fromARGB(45, 217, 217, 217);
  ...
  // Add more color constants as needed for your project
}
